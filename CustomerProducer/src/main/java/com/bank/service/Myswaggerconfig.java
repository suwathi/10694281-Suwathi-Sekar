...
public class Myswaggerconfig {
	...
	private ApiInfo metadata() {
		return new ApiInfoBuilder().title("LTI Fullstack++").description("API reference guide ProducerController").termsOfServiceUrl("https://mylti.lntinfotech.com/").version("1.0").build();	
	}
}
